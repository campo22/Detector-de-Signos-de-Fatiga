#!/usr/bin/env python3
# Versión de diagnóstico para ver los valores de detección
...
print("🔍 DIAGNÓSTICO DE DETECCIÓN DE SOMNOLENCIA")
print("=" * 50)
...
print("[INFO] Iniciando diagnóstico...")
print("🎯 INSTRUCCIONES:")
...
while True:
    ...
    cv2.imshow("Diagnóstico Drowsy", frame)
